...
A pasta raiz do pacote apresenta as seguintes sub-pastas: 
  ...
  + `./ex_cover_data` : a pasta apresenta dados de uso e cobertura para serem usados como exemplo, considerando como recorte o município de Itapetininga - SP. 
...
Além dos três modos de carregamento, o pacote `biomastats` apresenta dados de exemplo, do município de Itapetininga, armazenados na pasta `ex_cover_data`. 
