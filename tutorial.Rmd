...
Todas as informações relevantes são recuperadas quando o usuário carrega o arquivo `.Rdata`. O pacote Bioma Stats contém dois arquivos já recortados, para serem usados como exemplos, disponíveis na subpasta `examples` do diretório do pacote, na biblioteca pessoal do R. 
...
Para o usuário que recebe o arquivo, todos os passos anteriores são desnecessários, e basta carregar o arquivo `.Rdata`
