...
make_polygon(lat = -23.605, lon = -48.529, size = 1.5, shape = "hexagon")
```
...
```{r message=FALSE, warning=FALSE, results='hide'}
mapas_1 <- load_rasters(shape_path =  shp_path, start = 1985, end = 2020, method = "download", 
                        export_folder_path = "./meus-mapas/")
```

```{r}
land_vis(mapas_1, year = 2020)
```
